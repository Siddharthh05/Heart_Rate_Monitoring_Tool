...
This project is a simple Python-based Heart Rate Analysis Tool that helps users understand their heart-rate readings. Many people can measure their pulse but are unsure whether the values are normal, low, or high. This tool solves that by taking multiple readings, calculating key statistics, and giving a clear analysis along with a line graph for better understanding.
...
\* Input multiple heart-rate readings with time

\* Validation for incorrect or non-positive inputs
...
\* Clean, modular design with separate Python files
...
\* Verify that the graph correctly matches the readings entered
